...
function scr_Joysticks(left_lr,left_ud,right_lr,right_ud,action_type,button) {
	...
	_gp_axislvu = gamepad_axis_value(0,gp_axislv) < -0.6;
	_gp_axislvd = gamepad_axis_value(0,gp_axislv) > 0.6;
	_gp_axisrhl = gamepad_axis_value(0,gp_axisrh)  < -0.75;
	_gp_axisrhr = gamepad_axis_value(0,gp_axisrh) > 0.75;
	_gp_axisrvu = gamepad_axis_value(0,gp_axisrv) < -0.6;
	_gp_axisrvd = gamepad_axis_value(0,gp_axisrv) > 0.6;
