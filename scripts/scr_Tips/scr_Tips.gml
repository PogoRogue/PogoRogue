...
function scr_Tips(){
	...
	"You can re-center yourself by pressing up.",
	"Use the training area to practice with the items you have discovered.",
	"Passive items last for the entire run.",
	"Certain items may pair particularly well with others. See if you can discover some of these combinations yourself!",
	...
	"Sometimes it's easier to bounce on an enemy from the side than from the top.",
	"Some weapons may be better for damage output, while others may be better for movement and control.",
	...
	"The most powerful weapons and active items are found in later areas.",
	"Some enemies take more damage if they are bounced on than if they are shot, and vice versa.",
	"You will obtain more gold from kills if you have an active combo.",
