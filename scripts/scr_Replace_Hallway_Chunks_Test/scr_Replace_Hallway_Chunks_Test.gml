...
function scr_Replace_Hallway_Chunks_Test(layout_grid){
	...
	for (var i = 0; i < grid_width; i++) {
	    for (var j = 0; j < grid_height; j++) {
			...
			// a two block chunk. 
			{
				...
				//With a 2 long hallway chunk. Replace ONLY ONE for testing
				if(total_vertical_hallways >= 4)
				{
				...
				//Do ONLY ONE for testing
				if(total_horizontal_hallways >= 4)
				{					
