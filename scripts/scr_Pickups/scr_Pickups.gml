...
function scr_Pickups(){
	...
	pickup_chargejump = {
		...
		cooldown_time: 600,
		cooldown_text: "冷却: " + string(600 / 60) + "秒",
		on_cooldown: false,
	...
	pickup_groundpound = {
		...
		cooldown_time: 300,
		cooldown_text: "冷却: " + string(300 / 60) + "秒",
		on_cooldown: false,
	...
	pickup_firedash = {
		...
		cooldown_time: 480,
		cooldown_text: "冷却: " + string(480 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: [state_free,state_freeze],
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_slowmo = {
		...
		cooldown_time: 1800,
		cooldown_text: "冷却: " + string(1800 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: all_states,
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_bulletblast = {
		...
		cooldown_time: 1200,
		cooldown_text: "冷却: " + string(1200 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: [state_free,state_freeze],
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_reload = {
		...
		cooldown_time: 420,
		cooldown_text: "冷却: " + string(420 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: all_states,
		key_held: false,
		reload_on_bounce: false,
	...
	cooldown_time: 1500,
	cooldown_text: "冷却: " + string(1500 / 60) + "秒",
	on_cooldown: false,
	states_to_call_in: all_states,
	key_held: false,
	reload_on_bounce: false,
	...
	pickup_pogomode = {
		...
		cooldown_time: 2100,
		cooldown_text: "冷却: " + string(2100 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: all_states,
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_jolt = {
		...
		cooldown_time: 3000,
		cooldown_text: "冷却: " + string(3000 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: all_states,
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_blizzard = {
		...
		cooldown_time: 2400,
		cooldown_text: "冷却: " + string(2400 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: all_states,
		key_held: false,
		reload_on_bounce: false,
	...
	pickup_dragster = {
		...
		cooldown_time: 900,
		cooldown_text: "冷却: " + string(900 / 60) + "秒",
		on_cooldown: false,
		states_to_call_in: [state_free],
		key_held: false,
		reload_on_bounce: false,
