...
if create_trail = true {
	randomize();
	var spd_multiplier = random_range(0.8,1.2);
	if trail_spawnrate = 1 {
		var new_hspd = (-hspd/4) * spd_multiplier;
		var new_vspd = (-vspd/4) * spd_multiplier;
	}else {
	...
	var new_hspd2 = (-hspd/4) * spd_multiplier2;
	var new_vspd2 = (-vspd/4) * spd_multiplier2;
	...
	if trail_spawnrate = 1 {
		...
		var new_hspd3 = (-hspd/4) * spd_multiplier2;
		var new_vspd3 = (-vspd/4) * spd_multiplier2;
		...
		var new_hspd4 = (-hspd/4) * spd_multiplier4;
		var new_vspd4 = (-vspd/4) * spd_multiplier4;
		...
		var new_hspd5 = (-hspd/4) * spd_multiplier4;
		var new_vspd5 = (-vspd/4) * spd_multiplier4;
