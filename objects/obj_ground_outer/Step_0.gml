...
if drawn_tiles = false and distance_to_object(obj_camera) < 500 and (instance_exists(obj_proc_gen_controller) || instance_exists(obj_sprite_test_room_generator)) 
or drawn_tiles = false and distance_to_object(obj_blink_box) < 500 and (instance_exists(obj_proc_gen_controller) || instance_exists(obj_sprite_test_room_generator)) { //500
	drawn_tiles = true;
	//set tiles
