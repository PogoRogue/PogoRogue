...
if drawn_tiles = false and distance_to_object(obj_player) < 500 and (instance_exists(obj_proc_gen_controller) || instance_exists(obj_sprite_test_room_generator) || room = room_boss_3) {
	drawn_tiles = true;
	//set tiles
