...
text_array: ["I'm going to now share a secret that \nonly the most \nhonorable Pogoers \nshould know.",
"Bouncing is not the \nonly way to reload \nyour weapons.",
"For some reason \nwe dare not question, \nthese weapons reload \nthemselves when \nthey get a kill.",
"It's like they thirst for violence or something. I envy \nsuch fervor, in a way...",
...
"While bouncing, hold down the button \nshown below the \nitem's slot to \ntry it out.",
...
"Figure it out, or else you can't progress. It's impossible. I think."],
lines_of_text: 4, 
parent_index: obj_drone_tutorial, 
track_y: true,
chars_per_line: 22,
