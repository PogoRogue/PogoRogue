if room_speed < 60 {
	...
	//draw slow mo meter
	if time_left > 0 and !instance_exists(obj_shieldbubble) {
		draw_set_color(make_color_rgb(242,240,229));
		draw_set_font(fnt_combo2);
		draw_set_halign(fa_left);
		draw_set_valign(fa_bottom);
		scr_Draw_Text_Outlined(17,156-7,"Magic Stopwatch",c_white);
	...
	}else if time > 0 and instance_exists(obj_shieldbubble) {
