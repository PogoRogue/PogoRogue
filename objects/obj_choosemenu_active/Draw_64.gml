...
if test_mode = false {
	scr_Draw_Text_Outlined(center_x,center_y-60,"选择一项技能:", c_white); //center_y - 140 //center_y-56
}else {
	scr_Draw_Text_Outlined(center_x,center_y-140-32,"选择一项技能:", c_white); //center_y - 140 //center_y-56	
}
