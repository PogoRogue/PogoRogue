...
if room = room_proc_gen_test {
	switch (global.phase) {
		...
		case 2: global.current_music = snd_music_level2; global.area_2_reached += 1;
		scr_Save_Real("area_2_reached",global.area_2_reached); break;	
		case 3: global.current_music = snd_music_level2; global.area_3_reached += 1;
		scr_Save_Real("area_3_reached",global.area_3_reached); break;	
	}
