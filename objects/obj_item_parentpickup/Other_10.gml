...
or obj_player.num_of_pickups = 0 {
	if obj_player.num_of_pickups = 0 {
		...
		if obj_player.pickup_1 != synergy_partner and pickup.is_synergy = false {
			...
			ini_close();
		}else if pickup.is_synergy = false {
			...
			if synergy_child1 = obj_player.pickup_1 or synergy_child2 = obj_player.pickup_1  {
				global.all_pickup_costs[0] = synergy_item.item_cost;
		...
		and pickup.is_synergy = false {
			...
			audio_play_sound(snd_activePowerup,0,false);
		}else if pickup.is_synergy = false  { //create synergy
			...
			if obj_player.pickup_1 = synergy_child1 or obj_player.pickup_2 = synergy_child1
			or obj_player.pickup_1 = synergy_child2 or obj_player.pickup_2 = synergy_child2 {
				if obj_player.pickup_1 = synergy_child1 or obj_player.pickup_1 = synergy_child2 {
				...
				}else if obj_player.pickup_2 = synergy_child1 or obj_player.pickup_2 = synergy_child2 {
