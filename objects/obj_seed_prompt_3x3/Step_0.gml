...
if fade_away = false {
	if controller = true {
		...
		if(keyboard_string != "") and no_key_pressed and string_length(code_string) < 10 {
		...
		if string_length(code_string) > 10 {
		    code_string = string_copy(code_string, 1, 10);
