...
if(!other.invinsible) and damage != 0 and other.hp > 0 {
	...
	if(!other.is_dead) {
		other.hp -= (damage + global.damage_buff - (global.damage_buff * laser_damage * (gun_name = "量子冲天炮" and global.damage_buff > 0)) - (global.damage_buff * slime_damage * (gun_name = "史莱姆发射器" and global.damage_buff > 0))) * other.bullet_defense * crit_dmg_mult;
		other.red_frames = 10;
