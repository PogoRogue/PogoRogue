//draw tiles (proc gen)
if distance_to_object(obj_player) < 768 and room != room_tutorial and room != room_starting_area
or distance_to_object(obj_blink_box_strike) < 768  and room != room_tutorial and room != room_starting_area
or distance_to_object(obj_blink_box) < 768 and room != room_tutorial and room != room_starting_area {
