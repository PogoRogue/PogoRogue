if draw_respawn = false and obj_player.image_yscale = 0 {
	...
	draw_sprite_ext(spr_player_zekai_falling_white,obj_player.image_index,obj_player.x+lengthdir_x(22,obj_player.angle+90),obj_player.y+lengthdir_y(22,obj_player.angle+90),new_xscale,new_yscale,obj_player.angle,c_white,1);
}