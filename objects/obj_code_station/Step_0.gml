...
if (colliding and key_interact and !instance_exists(obj_fade_in) and code_accepted = false and code_denied = false) {
	//enter seeding input code here
	instance_create_depth(x,y,depth,obj_code_prompt);
}